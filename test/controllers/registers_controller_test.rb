...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { email: @register.email, message: @register.message, name: @register.name, phone: @register.phone } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { email: @register.email, message: @register.message, name: @register.name, phone: @register.phone } }
